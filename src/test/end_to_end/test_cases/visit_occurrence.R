...
add_tb_sip_spo(id=400, numsipcod='A400', fecha_nac='1991-01-01', sexo='H') 
...
expect_visit_occurrence(person_id = 20, visit_start_date='2013-01-01', visit_end_date = '2013-05-01')
expect_no_visit_occurrence(person_id = 20, visit_start_date='2013-01-01', visit_end_date = '2013-02-01')

declareTest(id=402, 'Visit start and end date for ambulatory visits')
add_tb_sip_spo(id=402, numsipcod='A402', sexo = 'M')
add_tb_morbilid(numsipcod='A402', fecha_inicio = '2014-01-01', fecha_fin = '2013-03-01')
expect_visit_occurrence(person_id = 21, visit_start_date = '2014-01-01', visit_end_date = '2014-01-01')

declareTest(id=403,'Visit outside valid observation period')
add_tb_sip_spo(id=403, numsipcod='A403', sexo = 'M') 
add_tb_morbilid(numsipcod='A403', fecha_inicio = '2009-01-01', fecha_fin = '2013-03-01')
expect_no_visit_occurrence(person_id = 22, visit_start_date = '2009-01-01')
