...
add_tb_sip_spo(id=1,numsipcod='A001', fecha_nac='1991-01-01', sexo='H')
...
add_tb_sip_spo(id=2,numsipcod='A002', sexo = 'M')
expect_person(person_source_value='A002', gender_concept_id=8532)

declareTest(id=3, description = 'Person male')
add_tb_sip_spo(id=3,numsipcod='A003', fecha_nac='1991-01-01', sexo='H')
...
add_tb_proc_cmbd(id=6, numsipcod='INVALIDSIPCODE', cie9p = '10.10')
