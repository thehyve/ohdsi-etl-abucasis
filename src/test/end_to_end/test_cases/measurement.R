...
expect_measurement(person_id=32,measurement_id=1, measurement_date='2012-05-05')
...
expect_no_measurement(person_id = 33)
...
expect_no_measurement(person_id = 34)
...
expect_measurement(person_id=35, measurement_id=4, measurement_date='2012-05-05')
...
expect_measurement(person_id=36, measurement_id=2,value_as_concept_id = 0)
...
expect_measurement(person_id=37, measurement_id=3,value_as_number = 6)
...
expect_measurement(person_id=38, measurement_id=5,measurement_date='2015-09-09')
