...
ALTER TABLE cdm5.drug_era
  ADD COLUMN IF NOT EXISTS drug_era_start_date date;
ALTER TABLE cdm5.drug_era
  ADD COLUMN IF NOT EXISTS drug_era_end_date date;
-- Condition era
ALTER TABLE cdm5.condition_era
    ADD COLUMN IF NOT EXISTS condition_era_start_date date;
ALTER TABLE cdm5.condition_era
  ADD COLUMN IF NOT EXISTS condition_era_end_date date;
