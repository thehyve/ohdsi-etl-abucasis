...
--*********************************************************************************
-- 1. This script will hold a number of placeholders for your CDM V5 database/schema. 
--*********************************************************************************

SET search_path TO abucasis;
/****
CONDITION ERA
...
FROM
abucasis.cdm5.CONDITION_OCCURRENCE co;
...
INSERT INTO abucasis.cdm5.condition_era (
    condition_era_id
    ,person_id
    ,condition_concept_id
