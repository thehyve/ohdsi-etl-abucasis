...
add_tb_sip_spo(id=500, numsipcod='A500', sexo = 'M')
...
expect_drug_exposure(person_id=23, drug_exposure_id = 1, drug_exposure_start_date = '2015-05-05', drug_exposure_end_date = '2015-06-04')

declareTest(id=501,'Drug exposure derivation of total days supply from treatment dates')
add_tb_sip_spo(id=501, numsipcod='A501', fecha_nac='1991-01-01', sexo='H') 
...
expect_drug_exposure(person_id=24, drug_exposure_start_date = '2015-05-06', drug_exposure_end_date = '2015-05-11')

declareTest(id=502,'Drug exposure quantity calculation per hour')
add_tb_sip_spo(id=502, numsipcod='A502', fecha_nac='1991-01-01', sexo='H') 
...
expect_drug_exposure(person_id=25, drug_exposure_start_date = '2017-01-01', quantity=30)

declareTest(id=503,'Drug exposure quantity calculation per day')
# 180 days, 5 per 2 days over 1 precription = 450
add_tb_sip_spo(id=503, numsipcod='A503', fecha_nac='1991-01-01', sexo='H') 
...
expect_drug_exposure(person_id=26, drug_exposure_start_date = '2017-02-01', quantity=450)

declareTest(id=504,'Drug exposure quantity with other posologia')
add_tb_sip_spo(id=504, numsipcod='A504', fecha_nac='1991-01-01', sexo='H') 
...
expect_drug_exposure(person_id=27, drug_exposure_start_date = '2017-04-01', quantity=50)

declareTest(id=505,'Drug exposure quantity with zero cadencia')
add_tb_sip_spo(id=505, numsipcod='A505', fecha_nac='1991-01-01', sexo='H') 
...
expect_drug_exposure(person_id=28, drug_exposure_start_date = '2017-03-01', quantity=31)

declareTest(id=506,'Drug exposure quantity and days_supply over multiple prescriptions')
add_tb_sip_spo(id=506, numsipcod='A506', fecha_nac='1991-01-01', sexo='H') 
...
expect_drug_exposure(person_id=29, drug_exposure_start_date = '2016-05-01', quantity=60, days_supply=30)

declareTest(id=507,'Drug exposure refill')
add_tb_sip_spo(id=507, numsipcod='A507', fecha_nac='1991-02-01', sexo='H') 
...
expect_drug_exposure(person_id=30, drug_exposure_start_date = '2016-06-01', refills=1)
expect_drug_exposure(person_id=30, drug_exposure_start_date = '2016-07-01', refills=2)
...
add_tb_sip_spo(id=508, numsipcod='A508', fecha_nac='1991-01-01', sexo='H') 
...
add_tb_prescrip(id=508,numsipcod='A508', numreceta = 'RE111', id_tratamiento = 'TR300',fecha_prescripcion='2018-01-10')
...
add_tb_rele(id=508,numsipcod='A508', numreceta = 'RE111', fecha_dispensacion = '2018-01-10')
